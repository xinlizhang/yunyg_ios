...
#import "LoginViewController_iph.h"
#import "GoodsDescriptionViewController_iph.h"
#import "GoodsPropertiesViewController_iph.h"
#import "CommentListViewController_iph.h"
#import "CommentAddViewController_iph.h"
#import "MZTimerLabel.h"
#import "MyWebViewController_iph.h"

@interface GoodsDetailViewController_iph ()
{
...
@implementation GoodsDetailViewController_iph
...
-(void)initUI
{
    ...
    // 收藏 加入购物车背景
    UIView* bottomBar1 = [[UIView alloc] initWithFrame:CGRectMake(0, frameR.size.height-40, frameR.size.width*3/5, 40)];
    ...
    // 立即购买
    UIView* bottomBar2 = [[UIView alloc] initWithFrame:CGRectMake(bottomBar1.frame.size.width, frameR.size.height-40, frameR.size.width*2/5, 40)];
    ...
    [wordsBuyNowLabel setFont:[UIFont systemFontOfSize:16]];
...
- (void)viewWillDisappear:(BOOL)animated {
    NSLog(@"GoodsDetailViewController_iph viewWillDisappear start!");
    ...
    NSLog(@"GoodsDetailViewController_iph viewWillDisappear end!");
}
...
-(void)updateUI
{
    ...
    GalleryScrollView_iph* galleryScrollView = [[GalleryScrollView_iph alloc] initWithFrame:CGRectMake(0, top, frameR.size.width, height)];
    ...
    top = top + height + 10;
    height = 40;
    UILabel* goodsNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, top, frameR.size.width-15-25, height)];
    ...
    top = top + height + 10;
    height = 16;
    UILabel* goodsPriceLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, top, frameR.size.width-30, height)];
    ...
    if ( [[_goodsDetailDic objectForKey:@"is_promote"] compare:@"1"] == NSOrderedSame )
    {
        ...
        UILabel* timerWdsLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, top, 70, height)];
        ...
        timerLabel.frame = CGRectMake(15+70, top, frameR.size.width-100, height);
    ...
    for (int i = 0; i < [attributeArray count]; i++)
    {
        ...
        // 显示属性标题
        UILabel* attriNameLable= [[UILabel alloc] initWithFrame:CGRectMake(15, top, frameR.size.width-30, height)];
    ...
    top = top + height + 10;
    height = 25;
    _reduceBtn = [[UIButton alloc] initWithFrame:CGRectMake(15, top, 25, height)];
    ...
    top = top + height + 10;
    height = 16;
    UILabel* addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, top, frameR.size.width-30, height)];
    ...
    addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(15 + 35, top, frameR.size.width-30, height)];
    ...
    top = top + height + 10;
    height = 16;
    UILabel* serviceLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, top, frameR.size.width-30, height)];
    ...
    serviceLabel = [[UILabel alloc] initWithFrame:CGRectMake(15 + 35, top, frameR.size.width-30, height)];
    ...
    top = top + height + 10;
    height = 16;
    UILabel* noticeLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, top, frameR.size.width-30, height)];
    ...
    noticeLabel = [[UILabel alloc] initWithFrame:CGRectMake(15 + 35, top, frameR.size.width-30, height)];
    ...
    top = top + height + 10;
    height = 40;
    UIButton* introductionBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 307, height)];
    [introductionBtn setCenter:CGPointMake(frameR.size.width/2, top+height/2)];
    [introductionBtn setImage:[UIImage imageNamed:@"detail_btn_bg_nor"] forState:UIControlStateNormal];
    [introductionBtn setImage:[UIImage imageNamed:@"detail_btn_bg_sel"] forState:UIControlStateSelected];
    [introductionBtn addTarget:self action:@selector(onIntroductionClicked:) forControlEvents:UIControlEventTouchUpInside];
    [_scrollView addSubview:introductionBtn];
    [introductionBtn release];
    
    CGRect frameLable = introductionBtn.frame;
    frameLable.size.width -= 20;
    UILabel* introductionLable = [[UILabel alloc] initWithFrame:frameLable];
    [introductionLable setText:@"商品介绍"];
    [introductionLable setNumberOfLines:1];
    [introductionLable setTextColor:[UIColor blackColor]];
    [introductionLable setCenter:introductionBtn.center];
    [introductionLable setTextAlignment:NSTextAlignmentLeft];
    ...
    top = top + height + 10;
    height = 40;
    UIButton* specificationParamBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 307, height)];
    [specificationParamBtn setCenter:CGPointMake(frameR.size.width/2, top+height/2)];
    [specificationParamBtn setImage:[UIImage imageNamed:@"detail_btn_bg_nor"] forState:UIControlStateNormal];
    [specificationParamBtn setImage:[UIImage imageNamed:@"detail_btn_bg_sel"] forState:UIControlStateSelected];
    [specificationParamBtn addTarget:self action:@selector(onSpecificationParamClicked:) forControlEvents:UIControlEventTouchUpInside];
    [_scrollView addSubview:specificationParamBtn];
    [specificationParamBtn release];
    
    frameLable = specificationParamBtn.frame;
    frameLable.size.width -= 20;
    UILabel* specificationParamLable = [[UILabel alloc] initWithFrame:frameLable];
    ...
    [specificationParamLable setCenter:specificationParamBtn.center];
    [specificationParamLable setTextAlignment:NSTextAlignmentLeft];
    ...
    top = top + height + 10;
    height = 40;
    UIButton* customerServiceBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 307, height)];
    [customerServiceBtn setCenter:CGPointMake(frameR.size.width/2, top+height/2)];
    [customerServiceBtn setImage:[UIImage imageNamed:@"detail_btn_bg_nor"] forState:UIControlStateNormal];
    [customerServiceBtn setImage:[UIImage imageNamed:@"detail_btn_bg_sel"] forState:UIControlStateSelected];
    [customerServiceBtn addTarget:self action:@selector(onCustomerServiceClicked:) forControlEvents:UIControlEventTouchUpInside];
    [_scrollView addSubview:customerServiceBtn];
    [customerServiceBtn release];
    
    frameLable = customerServiceBtn.frame;
    frameLable.size.width -= 20;
    UILabel* customerServiceLable = [[UILabel alloc] initWithFrame:frameLable];
    ...
    [customerServiceLable setCenter:customerServiceBtn.center];
    [customerServiceLable setTextAlignment:NSTextAlignmentLeft];
    ...
    top = top + height + 10;
    height = 40;
    UIButton* commentAddBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 307, height)];
    [commentAddBtn setCenter:CGPointMake(frameR.size.width/2, top+height/2)];
    [commentAddBtn setImage:[UIImage imageNamed:@"detail_btn_bg_nor"] forState:UIControlStateNormal];
    [commentAddBtn setImage:[UIImage imageNamed:@"detail_btn_bg_sel"] forState:UIControlStateSelected];
    [commentAddBtn addTarget:self action:@selector(onCommentAddClicked:) forControlEvents:UIControlEventTouchUpInside];
    [_scrollView addSubview:commentAddBtn];
    [commentAddBtn release];
    
    frameLable = commentAddBtn.frame;
    frameLable.size.width -= 20;
    UILabel* commentAddLable = [[UILabel alloc] initWithFrame:frameLable];
    [commentAddLable setText:@"增加评论"];
    [commentAddLable setNumberOfLines:1];
    [commentAddLable setTextColor:[UIColor blackColor]];
    [commentAddLable setCenter:commentAddBtn.center];
    [commentAddLable setTextAlignment:NSTextAlignmentLeft];
    ...
    top = top + height + 10;
    height = 40;
    UIButton* customerBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 307, height)];
    [customerBtn setCenter:CGPointMake(frameR.size.width/2, top+height/2)];
    [customerBtn setImage:[UIImage imageNamed:@"detail_btn_bg_nor"] forState:UIControlStateNormal];
    [customerBtn setImage:[UIImage imageNamed:@"detail_btn_bg_sel"] forState:UIControlStateSelected];
    [customerBtn addTarget:self action:@selector(onCustomerAddClicked:) forControlEvents:UIControlEventTouchUpInside];
    [_scrollView addSubview:customerBtn];
    [customerBtn release];
    
    frameLable = customerBtn.frame;
    frameLable.size.width -= 20;
    UILabel* customerLable = [[UILabel alloc] initWithFrame:frameLable];
    [customerLable setText:@"联系客服"];
    [customerLable setNumberOfLines:1];
    [customerLable setTextColor:[UIColor blackColor]];
    [customerLable setCenter:customerBtn.center];
    [customerLable setTextAlignment:NSTextAlignmentLeft];
    ...
    int iTotalH = top + height + 40 + 3;        // 40 底边栏高度
...
-(void)onBuyNowClicked:(id)sender
{
    ...
    else
    {
        ...
        {
            _isWaiting4BuyNow = true;
            BasicViewController_iph *viewControllerList = [[LoginViewController_iph alloc] init];
...
{
    BasicViewController_iph *viewController = [[GoodsDescriptionViewController_iph alloc] init];
...
{
    GoodsPropertiesViewController_iph *viewController = [[GoodsPropertiesViewController_iph alloc] init];
...
{
    CommentListViewController_iph *viewController = [[CommentListViewController_iph alloc] init];
    viewController.iGoodsID2Info = _iGoodsID;
    [self.navigationController pushViewController:viewController animated:YES];
}
...
{
    CommentAddViewController_iph *viewController = [[CommentAddViewController_iph alloc] init];
...
{
    BasicViewController_iph *viewController = [[MyWebViewController_iph alloc] init];

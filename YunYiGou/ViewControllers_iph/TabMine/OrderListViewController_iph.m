...
#import "OrderExpressViewController_iph.h"
#import "MyAlert.h"
...
@interface OrderListViewController_iph ()<EGORefreshTableDelegate,UIAlertViewDelegate>
{
...
@implementation OrderListViewController_iph
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel* amountLable = [[UILabel alloc] initWithFrame:CGRectMake(relationP.x+amountWdsW-10, relationP.y, amountFeeW+25, height)];
    ...
    if ( [_orderType compare:@"await_pay"] == NSOrderedSame )
    {
        ...
        [gotoPayLabel.layer setBackgroundColor:[UIColor whiteColor].CGColor];
        ...
        gotoPayLabel.textColor = [UIColor grayColor];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OrderDetailViewController_iph *viewController = [[OrderDetailViewController_iph alloc] init];
...
-(void)onGotoPayClicked:(UITapGestureRecognizer*)sender
{
    ...
    [net request_PayOrder_Datasuc:^(id success) {
        ...
        if ( success[@"status"] && [[success[@"status"] valueForKey:@"succeed"] intValue] == 1 )
        {
            ...
            MyWebViewController_iph *viewController = [[MyWebViewController_iph alloc] init];
            [self.navigationController pushViewController:viewController animated:YES];
...
-(void)onShippingClicked:(UITapGestureRecognizer*)sender
{
    ...
    OrderExpressViewController_iph *viewController = [[OrderExpressViewController_iph alloc] init];
    [self.navigationController pushViewController:viewController animated:YES];

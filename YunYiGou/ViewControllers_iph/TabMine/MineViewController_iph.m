...
#import "UserInfoViewController_iph.h"
#import "DataCenter.h"
#import "OrderListViewController_iph.h"
#import "AddrListMngViewController_iph.h"
#import "HelpListViewController_iph.h"
#import "CollectViewController_iph.h"
#import "AboutViewController_iph.h"

@interface MineViewController_iph ()
{
    int             _iTopBarH;
...
@implementation MineViewController_iph
...
-(void)initUI
{
    ...
    // 登陆 / 头像
    _loginBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 60, 60)];
    [_loginBtn setCenter:CGPointMake(frameR.size.width/2, relationP.y+45)];
    ...
    // 账户管理
    UIView* countMngView = [[UIView alloc] initWithFrame:CGRectMake(0, userInfoBG.frame.size.height-35, frameR.size.width, 35)];
    ...
    UILabel* countMngLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, userInfoBG.frame.size.height-35, frameR.size.width-60, 40)];
    ...
    UIImageView* listIcon = [[UIImageView alloc] initWithFrame:CGRectMake(20, 10, 20, 20)];
    ...
    UILabel* myOrderLable = [[UILabel alloc] initWithFrame:CGRectMake(60, 0, frameLable.size.width-120, frameLable.size.height)];
    ...
    UILabel* myAllOrderLable = [[UILabel alloc] initWithFrame:CGRectMake(30, 0, frameLable.size.width-60, frameLable.size.height)];
    ...
    [rightIdentify setCenter:CGPointMake(frameR.size.width-25, height/2)];
    ...
    int distanceX = 80;
    int distanceY = 22;
    CGPoint orderCenterP = CGPointMake(40, 22);
    ...
    UIImageView* addrIcon = [[UIImageView alloc] initWithFrame:CGRectMake(20, 10, 20, 20)];
    ...
    UILabel* addrWordsLable = [[UILabel alloc] initWithFrame:CGRectMake(60, 0, addrLable.size.width-120, addrLable.size.height)];
    ...
    UIImageView* collectIcon = [[UIImageView alloc] initWithFrame:CGRectMake(20, 10, 20, 20)];
    [collectIcon setImage:[UIImage imageNamed:@"mine_btn_icon_collect"]];
    [collectView addSubview:collectIcon];
    [collectIcon release];
    
    UILabel* collectLable = [[UILabel alloc] initWithFrame:CGRectMake(60, 0, collectView.frame.size.width-120, collectView.frame.size.height)];
...
-(void)onLoginClicked:(id)sender
{
    if ( [DataCenter sharedDataCenter].isLogin )
    {
        UserInfoViewController_iph *viewControllerList = [[UserInfoViewController_iph alloc] init];
...
-(void)onMyOrderListClicked:(UITapGestureRecognizer*)sender
{
    ...
    BasicViewController_iph *viewControllerList = [[OrderListViewController_iph alloc] init];
...
-(void)onAddrManageClicked:(UITapGestureRecognizer*)sender
{
    ...
    BasicViewController_iph *viewControllerList = [[AddrListMngViewController_iph alloc] init];
    [self.navigationController pushViewController:viewControllerList animated:YES];
}
...
-(void)onMyCollectClicked:(UITapGestureRecognizer*)sender
{
    ...
    BasicViewController_iph *viewControllerList = [[CollectViewController_iph alloc] init];
    [self.navigationController pushViewController:viewControllerList animated:YES];
}
...
{
    BasicViewController_iph *viewControllerList = [[HelpListViewController_iph alloc] init];
    [self.navigationController pushViewController:viewControllerList animated:YES];
}
...
{
    BasicViewController_iph *viewControllerList = [[AboutViewController_iph alloc] init];
    [self.navigationController pushViewController:viewControllerList animated:YES];
}

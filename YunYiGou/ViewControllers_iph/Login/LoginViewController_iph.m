...
@interface LoginViewController_iph ()
{
...
@implementation LoginViewController_iph
...
{
    BasicViewController_iph *viewControllerList = [[RegisterViewController_iph alloc] init];

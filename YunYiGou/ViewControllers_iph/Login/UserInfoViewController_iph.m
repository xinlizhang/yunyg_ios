...
#import "InfoEditViewController_iph.h"
#import "MyAlert.h"

@interface UserInfoViewController_iph ()
{
    int                     _iTopBarH;
    int                     _iTVCellH;
...
@implementation UserInfoViewController_iph
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        InfoEditViewController_iph *viewControllerEdit = [[InfoEditViewController_iph alloc] init];

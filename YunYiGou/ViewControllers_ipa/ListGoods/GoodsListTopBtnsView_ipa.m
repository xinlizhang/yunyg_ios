...
@interface GoodsListTopBtnsView_ipa ()
{
...
@implementation GoodsListTopBtnsView_ipa
...
- (void)initUI
{
    ...
    [_defaultWdsLabel setCenter:CGPointMake(self.frame.size.width*1/8, self.frame.size.height/2)];

...
#import "GoodsListTopBtnsView_ipa.h"

@interface GoodsListViewController_ipa ()<EGORefreshTableDelegate,GoodsListTopBtnsViewProtocol>
{
    ...
    // TOP
    GoodsListTopBtnsView_ipa*   _topBtnsView;
...
@implementation GoodsListViewController_ipa
...
-(void)initUI
{
    ...
    _topBtnsView = [[GoodsListTopBtnsView_ipa alloc] initWithFrame:CGRectMake(0, 0, r.size.width, _topBtnsH)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 商品图片
    CGPoint relationP = CGPointMake(30, 7);
    UIImageView * iv = [[UIImageView alloc] initWithFrame:CGRectMake(relationP.x, relationP.y, _tableViewCellH - 20, _tableViewCellH - 20)];
    ...
    relationP.y += 6;
    UILabel* nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(relationP.x, relationP.y, frameR.size.width - _tableViewCellH - 30, 35)];
    ...
    UILabel* priceLabel = [[UILabel alloc] initWithFrame:CGRectMake(relationP.x, relationP.y, frameR.size.width - _tableViewCellH - 20, 15)];
    ...
    if( [_clickedItemName compare:@"promote"] == NSOrderedSame )
    {
        ...
        UILabel* saveMoneyLabel = [[UILabel alloc] initWithFrame:CGRectMake(relationP.x, relationP.y, 60, 18)];
        ...
        [saveMoneyLabel setFont:[UIFont systemFontOfSize:11]];
        ...
        [snappingLabel setFont:[UIFont systemFontOfSize:15]];
    ...
    UIView* seperatorlINE = [[UIView alloc] initWithFrame:CGRectMake(0, _tableViewCellH - 1, frameR.size.width-30, 0.5)];

...
@interface LimitPromotionView_ipa ()
{
    MZTimerLabel*   _timerLabel;
}
@end

@implementation LimitPromotionView_ipa
...
- (void)initUI
{
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 15, 90, 16)];
    ...
    _timerLabel.frame = CGRectMake(_titleLabel.frame.origin.x+_titleLabel.frame.size.width, 15, 100, 16);
...
-(void)updateWithDataArray:(NSMutableArray*)dataArray
{
    ...
    for (int i = 0; i < [_dataArr count]; i ++) {
        ...
        CGPoint p = CGPointMake(offset/2 + offset * i, offset/2+50);

...
@interface CommentListViewController_ipa () <EGORefreshTableDelegate>
{
    int                         _iTopBarH;
    int                         _iTVCellH;
...
@implementation CommentListViewController_ipa
...
{
    NSLog(@"CommentListViewController_ipa viewWillAppear start!");
    ...
    [self requestData];
    NSLog(@"CommentListViewController_ipa viewWillAppear end!");
}

- (void)viewWillDisappear:(BOOL)animated
{
    NSLog(@"CommentListViewController_ipa viewWillDisappear start!");
    ...
    NSLog(@"CommentListViewController_ipa viewWillDisappear end!");
}

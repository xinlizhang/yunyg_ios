...
@interface HelpListViewController_ipa ()
{
...
@implementation HelpListViewController_ipa
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BasicViewController_ipa *viewController = [[ArticleDetailViewController_ipa alloc] init];

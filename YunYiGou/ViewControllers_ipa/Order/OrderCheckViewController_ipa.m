...
#import "OrderAddrMngViewController_ipa.h"
#import "OrderGoodsListViewController_ipa.h"
#import "OrderPayAndShipViewController_ipa.h"
#import "OrderDoneViewController_ipa.h"
#import "AddrEditViewController_ipa.h"

@interface OrderCheckViewController_ipa ()
{
...
@implementation OrderCheckViewController_ipa
...
{
    BasicViewController_ipa *viewController = [[OrderAddrMngViewController_ipa alloc] init];
...
{
    BasicViewController_ipa *viewController = [[OrderPayAndShipViewController_ipa alloc] init];
    [self.navigationController pushViewController:viewController animated:YES];
}
...
-(void)onCommitClicked:(id)sender
{
    ...
    [net request_DoneOrder_Datasuc:^(id success) {
        ...
        if ( success[@"status"] && [[success[@"status"] valueForKey:@"succeed"] intValue] == 1 )
        {
            ...
            BasicViewController_ipa *viewController = [[OrderDoneViewController_ipa alloc] init];
            [self.navigationController pushViewController:viewController animated:YES];
        }

...
@interface OrderDetailViewController_ipa ()  <UIScrollViewDelegate>
{
...
@implementation OrderDetailViewController_ipa
...
-(void)updateDetailUI
{
    ...
    float amountFeeW = [Utils widthForString:amountFee fontSize:18]+50;
